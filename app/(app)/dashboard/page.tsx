...
const UI = {
  ...
  // ⬇️ Added top padding so the gradient “background on top” is taller
  shell:
...
function KPIStrip({ data, isLoading }: { data?: KPIMetrics; isLoading: boolean }) {
  if (isLoading || !data) {
    return (
...
/* -------------------------------
   ...
   - Welcome
   - KPIs
   - Row: [Check-in (2 cols) | Recent (1 col, full height)]
   - Quick Start
-------------------------------- */
